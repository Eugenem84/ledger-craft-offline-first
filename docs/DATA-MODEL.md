...
> («веломастер + аквариумист») — схема это выдерживает уже сейчас, а UI мульти-профиля — Фаза 10
> (`docs/FRONTEND.md` §9, задачи 10.1–10.9).

**Запланировано (Фаза 10, задача 10.6) — колонки профиля:**
...
## Рабочие профили (мульти-специализация) и пресеты — запланировано (Фаза 10)
...
**Пресет специализации** = стартовый каталог + метаданные UI. Планируемые сущности:
