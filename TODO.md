...
- [ ] **Фаза 14** — Обратная связь: «Сообщить об ошибке» · FE 14/21 · BE 1/1 · FE+BE 1/2 · *петля работает на живом контуре: три отчёта мастеров разобраны и исправлены (14.11 — чип синка, 14.15 — удаление заказа со строками, 14.19 — количество работ/товаров в заказе), плюс правки владельца после прогона на телефоне (14.20 — верный итог списка, 14.21 — карточка без себестоимости, 14.22 — причина отказа сервера, 14.23 — подсказки/ширина/шагомер количества/«что нового» списком, 14.24 — склад: вкладки «товары» и «движение товаров» с историей и правкой приходов, 14.25 — маржа: закупка строк и цена закупки товара); остались авто-отчёт о сбое, «последние экраны» в диагностике, услуга/клиент в заказах (14.16), автобэкап (14.17), «полный сброс» (14.18) и живой прогон*
...
## Фаза 14 — Обратная связь: «Сообщить об ошибке» (P1/P2) — 🔧 в работе (14.1–14.7 + 14.11 + 14.14 + 14.15 + 14.19–14.25 сделаны)
